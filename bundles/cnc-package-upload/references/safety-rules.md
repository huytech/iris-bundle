...
12. Không tạo folder ngoài config; nếu thiếu cây gói hoặc folder con theo template, phải preview danh sách sẽ tạo/bổ sung và chỉ gọi `scripts/sp_cnc_package_ops.py create` sau khi user xác nhận rõ phần đó.
